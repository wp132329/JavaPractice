...
public class NaverSearch {
	...
	public static void main(String[] args) {		
	    ...
	    try (BufferedWriter bufwr = new BufferedWriter(new FileWriter(new File("files/movies.txt")))){
	    	String keyword = null;
	        ...
	        for(int i = 0; i< movieList.size(); i++) {
	        	System.out.println(i + ". " + movieList.get(i).getTitle() + " - " + movieList.get(i).getActors());
	        	bufwr.write(i + ". " + movieList.get(i).getTitle() + " - " + movieList.get(i).getActors()+"\n");
